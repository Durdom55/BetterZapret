...
butOn_i = PhotoImage(file="ButtonOn.png")
butOff_i = PhotoImage(file="ButtonOff.png")
Bg1 = PhotoImage(file="BG1.png")
Bg2 = PhotoImage(file="BG2.png")
PathTr = PhotoImage(file="MewoTrue.png")
PathTrInv = PhotoImage(file="MewoTrueInv.png")
PathFl = PhotoImage(file="MewoFalse.png")
PathFlInv = PhotoImage(file="MewoFalseInv.png")
